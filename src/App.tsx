...
import type { Category, RecommendInput, StackRecommendation } from './domain/types'
...
export default function App() {
  ...
  const submit = (event: React.FormEvent) => {
    ...
    setResult(recommendStack(products, { categories: selectedCategories, budgetEurMonthly: budget, market: 'ES', priority }))
  }
